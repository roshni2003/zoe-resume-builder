...
const sidebarMenuButtonVariants = cva(
	"peer/menu-button flex w-full items-center gap-2 overflow-hidden rounded-md p-2 text-start text-sm outline-hidden ring-sidebar-ring transition-[width,height,padding] hover:bg-emerald-50 hover:text-emerald-700 focus-visible:ring-2 active:bg-emerald-50 active:text-emerald-700 disabled:pointer-events-none disabled:opacity-50 group-has-data-[sidebar=menu-action]/menu-item:pe-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-emerald-50 data-[active=true]:font-medium data-[active=true]:text-emerald-700 data-[state=open]:hover:bg-emerald-50 data-[state=open]:hover:text-emerald-700 group-data-[collapsible=icon]:size-8! group-data-[collapsible=icon]:p-2! [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0",
	{
		variants: {
			variant: {
				default: "hover:bg-emerald-50 hover:text-emerald-700",
				outline: "bg-background hover:bg-emerald-50 hover:text-emerald-700",
			},
			size: {
				default: "h-8 text-sm",
				sm: "h-7 text-xs",
